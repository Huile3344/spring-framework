 ...
 * <p>以不需要加载该方法的类的形式定义对特定方法的注解的抽象访问的接口。
 *
...
public interface MethodMetadata extends AnnotatedTypeMetadata {
	 ...
	 * <p>确定底层方法是否有效抽象：即在类中标记为抽象或在接口中声明为常规的非默认方法。
	 * @since 4.2
	 */
	boolean isAbstract();
	 ...
	 * <p>确定底层方法是否可覆盖，即未标记为 static、final 或 private。
	 */
