...
/**
 * PropertiesPropertySource 的子类，用于从给定 Resource 或资源位置加载 Properties 对象 ，
 * 例如 "classpath:/com/myco/foo.properties" 或"file:/path/to/file.xml" 。
 * <p>支持传统和基于 XML 的属性文件格式；但是，为了使 XML 处理生效，底层 Resource 的 getFilename() 方法必须
 * 返回一个以".xml"结尾的非null值。
 *
 * <p>Subclass of {@link PropertiesPropertySource} that loads a {@link Properties} object
...
public class ResourcePropertySource extends PropertiesPropertySource {
	...
	/**
	 * 返回此 ResourcePropertySource 的潜在适应变体，用指定的名称覆盖先前给出的（或派生的）名称。
	 * <p>Return a potentially adapted variant of this {@link ResourcePropertySource},
	...
	/**
	 * 返回此 ResourcePropertySource 的潜在适应变体，用原始资源名称（相当于无名构造函数变体生成的名称）
	 * 覆盖先前给定的名称（如果有）。
	 * <p>Return a potentially adapted variant of this {@link ResourcePropertySource},
	 ...
	 * <p>Return the description for the given Resource; if the description is
